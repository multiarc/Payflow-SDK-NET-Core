...
namespace PFProSDK.DataObjects
{
    ...
    ///     </para>
    ///     <para>
    ///         FpsXmlData data objects instances are contained in
    ///         FraduResponse and populated if obtained.
    ///     </para>
