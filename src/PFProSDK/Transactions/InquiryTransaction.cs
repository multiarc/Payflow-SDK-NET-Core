...
namespace PFProSDK.Transactions
{
    ...
    /// </summary>
    /// <remarks>
    ///     Inquiry transaction gets the status of a previously performed
    ...
    public sealed class InquiryTransaction : ReferenceTransaction
    {
        ...
        /// 	</code>
        /// </example>
        public InquiryTransaction(string origId, UserInfo userInfo, PayflowConnectionData payflowConnectionData,
            string requestId) : base(PayflowConstants.TrxtypeInquiry, origId, userInfo, payflowConnectionData,
            requestId)
        {
        }
        ...
        /// 	</code>
        /// </example>
        public InquiryTransaction(string origId, UserInfo userInfo, string requestId) : base(
            PayflowConstants.TrxtypeInquiry, origId, userInfo, requestId)
        {
        }
        ...
        /// </example>
        public InquiryTransaction(string origId, UserInfo userInfo, PayflowConnectionData payflowConnectionData,
            Invoice invoice, string requestId) : base(PayflowConstants.TrxtypeInquiry, origId, userInfo,
        ...
        /// 	</code>
        /// </example>
        public InquiryTransaction(string origId, UserInfo userInfo, Invoice invoice, string requestId) : this(origId,
